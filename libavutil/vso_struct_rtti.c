...
static const avstruct_field_descriptor AVCodecContext_field_list[] = {
  ...
  STRUCT_FIELD_DECL(AVCodecContext,side_data_prefer_packet), 
  STRUCT_FIELD_DECL(AVCodecContext,nb_side_data_prefer_packet), 
  STRUCT_FIELD_DECL(AVCodecContext,decoded_side_data), 
  STRUCT_FIELD_DECL(AVCodecContext,nb_decoded_side_data), 
  { NULL } 
};
...
static const avstruct_field_descriptor AVFormatContext_field_list[] = {
  ...
  STRUCT_FIELD_DECL(AVFormatContext,duration_probesize), 
  { NULL } 
};
